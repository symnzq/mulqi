                    ...
                    <div class="card-body">
                        <form action="proses-login-petugas.php" method="post">
                            <div class="form-group mb-2">
                                ...
                                <input style="background: white; border-color: black;" type="text" name="username"
                                    class="form-control" placeholder="Masukan Username anda .." required>
                            </div>
                            <div class="form-group mb-2">
                                <label>Password</label>
                                <input style="background: white; border-color: black;" type="password" name="password"
