...
<form method="post" action="?url=proses-edit-spp&id_spp=<?= $id_spp; ?>">
    ...
    <div class="form-group mb-2">
        <label>Bulan</label>
        <input value="<?= $data['Bulan'] ?>" type="text" name="Bulan" maxlength="999" class="form-control" required>
    </div>
    <div class="form-group mb-2">
        <label>Nominal</label>
        <input value="<?= $data['nominal'] ?>" type="number" name="nominal" maxlength="13" class="form-control"
            required>
    </div>
